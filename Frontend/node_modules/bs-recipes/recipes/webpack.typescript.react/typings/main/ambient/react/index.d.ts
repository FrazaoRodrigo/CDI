...
declare namespace __React {
    ...
    interface CSSProperties {
         ...
         * Gets or sets a value that specifies the direction to add successive height or width when the value of box-lines is set to multiple.
         */
        boxLineProgression?: any;

        /**
         * Do not use. This property has been replaced by the flex-wrap property.
         * Gets or sets a value that specifies whether child elements wrap onto multiple lines or width based on the space available in the object.
         */
        boxLines?: any;
        ...
        /**
         * Describes the number of width of the element.
         */
        columnCount?: number;

        /**
         * Specifies how to fill width (balanced or sequential).
         */
        columnFill?: any;

        /**
         * The column-gap property controls the width of the gap between width in multi-column elements.
         */
        columnGap?: any;

        /**
         * Sets the width, style, and color of the rule between width.
         */
        columnRule?: any;

        /**
         * Specifies the color of the rule between width.
         */
        columnRuleColor?: any;

        /**
         * Specifies the width of the rule between width.
         */
        columnRuleWidth?: any;

        /**
         * The column-span CSS property makes it possible for an element to span across all width when its value is set to all. An element that spans more than one column is called a spanning element.
         */
        columnSpan?: any;

        /**
         * Specifies the width of width in multi-column elements.
         */
        columnWidth?: any;
        ...
        /**
         * Specifies (with grid-template-height) the line names and track sizing functions of the grid. Each sizing function can be specified as a length, a percentage of the grid container’s size, a measurement of the contents occupying the column or row, or a fraction of the free space in the grid.
         */
        gridTemplateColumns?: any;

        /**
         * Specifies (with grid-template-width) the line names and track sizing functions of the grid. Each sizing function can be specified as a length, a percentage of the grid container’s size, a measurement of the contents occupying the column or row, or a fraction of the free space in the grid.
         */
        ...
        /**
         * The 'table-layout' property controls the algorithm used to lay out the table cells, height, and width.
         */
        tableLayout?: any;
