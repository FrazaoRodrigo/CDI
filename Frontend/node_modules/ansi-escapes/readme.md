...
// moves the cursor two height up and to the left
...
Move cursor up a specific amount of height. Default is `1`.

### cursorDown(count)

Move cursor down a specific amount of height. Default is `1`.

### cursorForward(count)

Move cursor forward a specific amount of height. Default is `1`.

### cursorBackward(count)

Move cursor backward a specific amount of height. Default is `1`.
...
Erase from the current cursor position up the specified amount of height.
