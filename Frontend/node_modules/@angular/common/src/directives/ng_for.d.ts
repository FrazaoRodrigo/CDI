 ...
 * controls
 * (such as `<input>` elements which accept user input) that are present. Inserted height can be
 * animated in, deleted height can be animated out, and unchanged height retain any unsaved state such
 * as user input.
 *
